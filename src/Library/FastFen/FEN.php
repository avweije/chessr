...
class FEN
{
    ...
    */
    public function get_legal_moves() : array
    {
      ...
      return array_values($pseudolegal_moves);
    }
    ...
    */
    private function standard_move(Move &$move) : void
    {
      ...
      $new_board = $this->get_new_board($move, $origin, true);
      //$this->set_board($new_board);
      $move->set_origin($origin);
    }

    private function get_new_board(Move $move, Square $origin, bool $setBoard = false) : Board
    {
      $new_board = $setBoard ? $this->board : clone $this->board;
